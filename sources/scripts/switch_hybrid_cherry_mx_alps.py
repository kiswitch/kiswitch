...
location_3d = "${KIPRJMOD}/Switch_Keyboard/packages3d/Switch_Keyboard_Cherry_MX.3dshapes/SW_Cherry_MX_PCB.wrl"
location_3d_2 = "${KIPRJMOD}/Switch_Keyboard/packages3d/Switch_Keyboard_Alps_Matias.3dshapes/SW_Alps_Matias.wrl"
